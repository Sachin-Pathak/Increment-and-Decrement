...
function App() {
  ...
  return (
    <div className=" w-[100vw] h-[100vh] flex justify-centre items-center bg-[#344151] flex-col gap-10">
      <div className ="text-[#0398d4] font-medium text-2xl mt-20">Increment && Decrement</div>
